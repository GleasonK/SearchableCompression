package me.kevingleason.szip.io; /*************************************************************************
 *  Compilation:  javac me.kevingleason.szip.io.BinaryIn.java
 *  Execution:    java me.kevingleason.szip.io.BinaryIn input output
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java me.kevingleason.szip.io.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>me.kevingleason.szip.io.BinaryIn</tt> with calls
